  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={(v) => !v && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[120] w-[calc(100%-2rem)] max-w-[900px] max-h-[90vh] h-[85vh] md:h-[90vh] rounded-xl shadow-xl bg-white overflow-hidden"
